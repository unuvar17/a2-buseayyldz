...
def create_hash(password):
    pw_bytestring = password.encode()  ## thiss function was taken: https://bitbucket.org/damienjadeduff/hashing_example/raw/master/hash_password.py
    return sha256(
...
comlist=[]
def comments():
    confirm_user_pw_hexdigit = "3a7bd3e2360a3d29eea436fcfb7e44c735d117c42d1c1835420b6b9942dd4f1b"  # it is hex digit of "muzo" that is my password"
